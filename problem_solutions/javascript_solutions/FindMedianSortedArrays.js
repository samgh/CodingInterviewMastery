 ...
 *
 *   Execution: node FindMedianSortedArrays.js
 */
...
var findMedianSortedArrays = function(nums1, nums2) {
    ...
    while (min <= max) {
        ...
        var nums1Mid = Math.floor((min + max) / 2);
        ...
        var nums2Mid = Math.floor((nums1.length + nums2.length + 1) / 2) - nums1Mid;
...
var tester = function() {
    ...
    console.assert(findMedianSortedArrays([1,3],[2,7]) == 2.5);
}
